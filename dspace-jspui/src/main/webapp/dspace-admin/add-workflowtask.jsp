...
<dspace:layout style="submission" titlekey="jsp.dspace-admin.eperson-main.title"
  ...
  $(function() {
	...
	<div align="right"><a class="btn btn-primary" href="<%=request.getContextPath()%>/dspace-admin/workflow-step?workflowId=<c:out value="${workflowId}"/>">Back</a></div>
...
<form id="taskform" action="" name="workflow_task" method="post"> 
	...
	<input type="hidden" name="step_id" value="<c:out value="${step_id}"/>"/>	
	<!--
 ...
 <div class="row"><label class="col-md-2" for="tlastname"></label><div class="col-md-5"></div></div></br>
	   ...
	   <div class="row">
            ...
            <div class="col-md-5">
				<input class="form-control" name="task_name" id="task_name" size="12" />
			</div>
       </div>
	   <br>
	   <div class="row">
            ...
            <div class="col-md-5">
				<input class="form-control" type="hidden" name="step_no" value="<c:out value="${stepno}"/>" /><b><c:out value="${stepno}"/></b>			
...
jQuery(document).ready(function($) {
 ...
 <div class="row"><label class="col-md-2" for="tlastname"></label><div class="col-md-5"></div></div>
	    ...
	    <div class="row">
			...
			<!--<select class="form-control" name="task_rule_id" id="task_rule_id">
	   ...
	   <textarea class="form-control" id="task_instruction" name="task_instruction" size="10" col="5" row="20"></textarea>
			...
			<label class="col-md-2" for="taskpermissions"></label>
			  <div class="col-md-5">
			  <input class="btn btn-success" type="submit" name="submit_add" value="Add Task">
			  </div>
			</div>
			</form>
	   </div>
