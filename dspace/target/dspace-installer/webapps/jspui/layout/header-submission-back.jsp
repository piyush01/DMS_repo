...
<script type='text/javascript' src='<%= request.getContextPath() %>/static/js/bootstrap/multiselect.js'></script>
	...
	<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/static/css/jquery.dataTables.css">
...
<header onclick="" class="navbar navbar-inverse navbar-fixed-top">    
    <%
