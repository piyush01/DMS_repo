...
%>
		...
		<p class="alert"><fmt:message key="jsp.register.edit-profile.info5"/></p>
            ...
            <div class="form-group">
							   ...
							   --%>
							   <div class="col-md-2">  
							<label  for="tpassword_confirm">Confirm Password</label>
							</div>
							<div class="col-md-3">
...
<div class="col-md-3">	  
	  <input class="btn btn-success" type="submit" name="submit" value="<fmt:message key="jsp.register.edit-profile.update.button"/>" />
	 </div>
	 </div>
	 </div>
    </form>
