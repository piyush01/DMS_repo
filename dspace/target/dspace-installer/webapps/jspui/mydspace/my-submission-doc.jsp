	...
	<div class="panel panel-primary">
		...
		<tbody>		 		
		 <tr>
			...
			<th  class="oddRowOddCol" >To Assign</th>			
            <th  class="oddRowOddCol" >Status</th>
			<th  class="oddRowOddCol" >Comments</th>
		    <th  class="oddRowEvenCol">Supervisor</th>
			<th  class="oddRowEvenCol">Deadline</th>
        </tr>	
		<dspace:docsumbit status="none"/>	
