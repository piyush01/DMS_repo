...
<dspace:layout style="submission" titlekey="jsp.dspace-admin.list-formats.title"
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					<h3 class="box-title"><fmt:message key="jsp.dspace-admin.list-formats.title"/>					
					</h3>
		...
		<div class="box-header with-border">			
			  <p class="alert alert-default"><fmt:message key="jsp.dspace-admin.list-formats.text1"/><br/><br/>
		<fmt:message key="jsp.dspace-admin.list-formats.text2"/></p>
       </div>
	  </div>
		<%
