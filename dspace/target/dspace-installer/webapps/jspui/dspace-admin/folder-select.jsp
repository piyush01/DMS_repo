...
<%
	...
	Community[] allcommunities = (Community[])request.getAttribute("allcommunities");
...
<dspace:layout style="submission" titlekey="jsp.dspace-admin.folder-select.title"
               navbar="admin"
               locbar="link"
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Folder Policy</h3>	
		 ...
		 <label>Folder</label>  
		  ...
		  <div class="col-sm-3">    
						...
						<%  for (int i = 0; i < allcommunities.length; i++) 
							{ 
						boolean found = true;
						 for (int j = 0; j <topcommunities.length; j++) {
							 if (allcommunities[i].getID()==topcommunities[j].getID()) {
                        found= false;
                    	
                        break;
						 }} if(found){%>
						 
								<option value="<%= allcommunities[i].getID()%>">
									<%= allcommunities[i].getMetadata("name")%>
								</option>
							   <% 
							}} 
						%>
