...
<dspace:layout style="submission" locbar="on"
               navbar="on"
...
%>
    ...
    <h1 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading1"/>
...
%>
	...
	<h3 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading2"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") + \"#wizard_permissions\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	</h3>
...
%>
	...
	<h3 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading3"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") + \"#wizard_permissions\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	</h3>
...
%>
	...
	<h3 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading4"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") + \"#wizard_permissions\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	</h3>
...
%>
	...
	<h3 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading5"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") + \"#wizard_permissions\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	</h3>
...
%>
	...
	<h3 class="box-title"><fmt:message key="jsp.dspace-admin.wizard-permissions.heading6"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") + \"#wizard_permissions\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	</h3>
