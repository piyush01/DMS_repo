...
<%
    ...
    {
%>
	    <h3><fmt:message key="jsp.submit.upload-file-list.heading2"/>
...
%>
		...
		<table class="table" align="center" summary="Table dispalying your submitted files">
            <tr>
				<th id="t1" class="oddRowEvenCol"></th>
...
%>
		...
		<td headers="t1" class="<%= row %>RowEvenCol" align="center">
		    <input class="form-control" type="hidden" name="primary_bitstream_id" value="<%= bitstreams[i].getID() %>"
			   <% if (bundles[0] != null) {
            ...
            <%      // Don't display "remove" button in workflow mode
			       // if Document is create version then remove delete button.
				   if(version!=null && version.equals("yes")){
