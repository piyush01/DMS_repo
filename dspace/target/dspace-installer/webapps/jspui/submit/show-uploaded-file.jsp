...
<dspace:layout style="default" locbar="commLink" titlekey="jsp.submit.upload-file-list.title">
...
%>
		...
		<h3><fmt:message key="jsp.submit.show-uploaded-file.heading1"/>
		<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.index\")+ \"#uploadedfile\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup></h3>

        <%-- <p><strong>Your file was successfully uploaded.</strong></p> --%>
		<p class="alert aler-info"><fmt:message key="jsp.submit.show-uploaded-file.info1"/></p>
<%
    }
    else
    {
%>
		...
		<h3><fmt:message key="jsp.submit.show-uploaded-file.heading2"/>
...
%>
  	<!--	<li class="uploadHelp"><fmt:message key="jsp.submit.show-uploaded-file.info7"/>
			...
			<fmt:message key="jsp.submit.show-uploaded-file.info8"/></dspace:popup>
