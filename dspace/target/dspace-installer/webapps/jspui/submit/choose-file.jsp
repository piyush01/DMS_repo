...
<dspace:layout style="default" locbar="commLink" titlekey="jsp.submit.choose-file.title">
...
<% } %>
    ...
    <form id="uploadForm" <%= bSherpa?"class=\"sherpa col-md-8\"":"" %> method="post" 
		...
		<br/><h2 class="box-title"><strong><fmt:message key="jsp.submit.choose-file.heading"/></strong>			
		</h2>    
...
%>
					...
					<input class="form-control" type="hidden" name="description" id="tdescription" size="40"/></span>
...
%></div>
	<br/>
        ...
        %>
			...
			<h3> <u><b>copy</b> path to upload</u> 
			 <input type="url" id="url_field"  onclick="this.select()" style="background: #006600; color: #FFF;" 
				  value="<%=url%>" size="40" width="2px" name="url" </h3>
