...
<%
    ...
    if (feedEnabled)
    {
        feedData = ConfigurationManager.getProperty("webui.feed.formats");
    }
%>
...
<%!
      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < fieldCount; i++)
      {
         ...
         sb.append("<div class=\"col-md-10\"><input placeholder=\"")           
         ...
         sb.append("value=\"")
           .append(dpn.getLastName().replaceAll("\"", "&quot;")) // Encode "
                   ...
                   .append("\" class=\"form-control\" type=\"hidden\" name=\"")
         ...
         sb.append("value=\"")
           .append(dpn.getFirstNames()).append("\"/></div>");         
      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < fieldCount; i++)
      {
         ...
         sb.append("<div class=\"row col-md-12\"><div class=\"form-group\">")
			.append("<span class=\"col-md-3\"><span>")
...
//          .append(">(No month)</option>");
         ...
         sb.append("</select></span>")
                ...
                .append("</span><input placeholder=\"00\" class=\"form-control\" type=\"text\" name=\"")
            .append(fieldName)
            .append("_day");
         if (repeatable && i>0)
            sb.append("_").append(i);
         ...
         sb.append("\" size=\"2\" maxlength=\"2\" value=\"")
            .append((dateIssued.getDay() > 0 ?
                ...
                .append("\"/></span><span class=\"col-md-2\"><span >")
                .append(LocaleSupport.getLocalizedMessage(pageContext, "jsp.submit.edit-metadata.year"))
                .append("</span><input placeholder=\"yyyy\" class=\"form-control\" type=\"text\" name=\"")
            .append(fieldName)
            .append("_year");
         if (repeatable && i>0)
            sb.append("_").append(i);
      ...
      throws java.io.IOException
    {
      ...
      sb.append("<div class=\"row\"><label class=\"col-md-2"+ (required?" label-required":"") +"\">")
      	.append(label)
      	.append("</label><div class=\"col-md-5\">");
      ...
      throws java.io.IOException
    {
	  ...
	  sb.append("<input class=\"form-control txtboxToFilter\" placeholder=\"[0-9] Only Numbers\" type=\"text\" name=\"")
             .append(fieldNameIdx)
             .append("\" id=\"")
...
//            .append("_add\" value=\"Add More\"/> </td></tr>");
      ...
      throws java.io.IOException
    {
      ...
      sb.append("<div class=\"row\"><label class=\"col-sm-2"+ (required?" label-required":"") +"\">")
        .append(label)
        .append("</label>");

      sb.append("<div class=\"col-md-10\"><span class=\"col-sm-3\">")
      ...
      sb.append("</select></span></div></div><br/>");
      out.write(sb.toString());
    }
...
<dspace:layout style="default" locbar="commLink" feedData="<%= feedData %>" titlekey="jsp.submit.edit-metadata.title">
...
%>
 ...
 <div class="row">
  ...
  <form class="form-horizontal" action="<%= request.getContextPath() %>/submit" method="post" name="edit_metadata" id="edit_metadata" onkeydown="return disableEnterKey(event);">        
        <h3 class="box-title">	
					<fmt:message key="jsp.submit.edit-metadata.heading"/>
					</h3>
					<h3 class="box-title">	
