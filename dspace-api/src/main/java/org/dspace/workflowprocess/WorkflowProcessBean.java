...
public class WorkflowProcessBean 
{
    ...
    private Integer bitstream_id;
    private String task_start;
    private Integer is_read;
    private Integer work_process_id;
	...
	public Integer getWork_process_id() {
		return work_process_id;
	}
	public void setWork_process_id(Integer work_process_id) {
	...
	public Integer getBitstream_id() {
		return bitstream_id;
	}
	public void setBitstream_id(Integer bitstream_id) {
	...
	private Integer workflow_stepid;
    
    private Integer workflow_taskid; 
...
public Integer getWorkflow_stepid() {
		return workflow_stepid;
	}
	public void setWorkflow_stepid(Integer workflow_stepid) {
		this.workflow_stepid = workflow_stepid;
	}
	public Integer getWorkflow_taskid() {
		return workflow_taskid;
	}
	public void setWorkflow_taskid(Integer workflow_taskid) {
		this.workflow_taskid = workflow_taskid;
	}
